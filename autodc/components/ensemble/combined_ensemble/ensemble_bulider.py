...
from autodc.components.ensemble.combined_ensemble.bagging import Bagging
from autodc.components.ensemble.combined_ensemble.blending import Blending
from autodc.components.ensemble.combined_ensemble.stacking import Stacking
from autodc.components.ensemble.combined_ensemble.ensemble_selection import EnsembleSelection
...
class EnsembleBuilder:
    ...
    def get_ens_model_details(self):
        return self.model.get_ens_model_details()
