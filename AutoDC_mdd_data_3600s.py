...
dm = DataManager()
train_data = dm.load_train_csv('./data/MDD_and_HCs/tpotfssRNASeq_train.csv', label_col=0)
print('==============================================================')
...
test_data = dm.load_test_csv('./data/MDD_and_HCs/tpotfssRNASeq_test.csv', has_label=True, label_col=0)
